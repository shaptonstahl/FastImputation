...
test_that("FastImputation catches bad input", {
  expect_error(
    FastImputation(good_test_set, verbose = FALSE),
    "A 'patterns' object generated by 'TrainFastImputation' must be specified."
  )
  expect_error(
    FastImputation(good_test_set, patterns = 5, verbose = FALSE),
  ...
  expect_error(
    FastImputation(bad_array, patterns = good_patterns, verbose = FALSE),
    "'x' must be a dataframe."
  )
  expect_error(
    FastImputation(bad_df, patterns = good_patterns, verbose = FALSE),
