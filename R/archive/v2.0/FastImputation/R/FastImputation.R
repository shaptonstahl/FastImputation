...
#' confusionMatrix(
#'   data = imputed_data$categorical_9[categorical_rows_imputed],
...
#' }
#' categorical_rows_imputed_col_mode <- rep(
#'   stat_mode(FI_test$categorical_9),
#'   length(categorical_rows_imputed)
#' )
#' confusionMatrix(
#'   data = categorical_rows_imputed_col_mode,
#'   reference = FI_true$categorical_9[categorical_rows_imputed]
#' )
