...
test_that("BoundNormalizedVariable catches bad input", {
  ...
  expect_error(
    BoundNormalizedVariable(x = good.x.vector, constraints = bad.constraints.order),
    "'upper' must be greater than 'lower.'"
  )
  expect_error(
    BoundNormalizedVariable(x = good.x.matrix, constraints = bad.constraints.order),
    "'upper' must be greater than 'lower.'"
  )
  expect_error(
  ...
  expect_error(
    BoundNormalizedVariable(x = good.x.array, constraints = bad.constraints.order),
    "'upper' must be greater than 'lower.'"
  )
})
